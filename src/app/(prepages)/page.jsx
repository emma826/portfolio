			...
			<main className="flex-auto">
				...
				<div className="sm:px-8 mt-16">
					<div className="mx-auto w-full max-w-7xl lg:px-8">
						<div className="relative px-4 sm:px-8 lg:px-12">
							<div className="mx-auto max-w-2xl lg:max-w-5xl">
								<ul role="list" className="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-3 lg:max-w-none max-w-xl mx-auto">
									<HomeProjects />
								</ul>
							</div>
						</div>
							...
							<div className="mx-auto max-w-2xl lg:max-w-5xl">
								<div className="mx-auto grid max-w-xl grid-cols-1 gap-y-20 lg:max-w-none lg:grid-cols-2">
									...
									<div className="space-y-10 lg:pl-16 xl:pl-24">
										...
										<form className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40" action="#">
											<h2 className="flex text-sm font-semibold text-zinc-900 dark:text-zinc-100">
												<svg viewBox="0 0 24 24" fill="none" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" className="h-6 w-6 flex-none">
