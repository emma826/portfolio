...
export default async function Blog_idPage({ params }) {
	...
	return (
		<div className="lg:flex lg:flex-row-reverse gap-2 lg:items-start lg:justify-between">
			...
			<div className="lg:w-80 rounded-2xl border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-white/[0.03]">
