    ...
    return (
        <div className="nextra-nav-container nx-sticky nx-top-0 nx-z-20 nx-w-full nx-bg-transparent">
            ...
            <nav className="nx-mx-auto nx-flex nx-h-[var(--nextra-navbar-height)] nx-max-w-[90rem] nx-items-center nx-justify-end nx-gap-2 nx-pl-[max(env(safe-area-inset-left),1.5rem)] nx-pr-[max(env(safe-area-inset-right),1.5rem)]">
                <a className="nx-flex nx-items-center hover:nx-opacity-75 ltr:nx-mr-auto rtl:nx-ml-auto" href="index.html"><span>My Project</span></a>
                <a className="nx-text-sm contrast-more:nx-text-gray-700 contrast-more:dark:nx-text-gray-100 nx-relative -nx-ml-2 nx-hidden nx-whitespace-nowrap nx-p-2 md:nx-inline-block nx-text-gray-600 hover:nx-text-gray-800 dark:nx-text-gray-400 dark:hover:nx-text-gray-200" aria-current="false" href="about">
                    <span className="nx-absolute nx-inset-x-0 nx-text-center">About</span>
                    <span className="nx-invisible nx-font-medium">About</span>
                </a>
                <a href="https://twitter.com/shuding_" target="_blank" rel="noreferrer" className="nx-text-sm contrast-more:nx-text-gray-700 contrast-more:dark:nx-text-gray-100 nx-relative -nx-ml-2 nx-hidden nx-whitespace-nowrap nx-p-2 md:nx-inline-block nx-text-gray-600 hover:nx-text-gray-800 dark:nx-text-gray-400 dark:hover:nx-text-gray-200" aria-current="false">
                    <span className="nx-absolute nx-inset-x-0 nx-text-center">Contact ↗</span>
                    <span className="nx-invisible nx-font-medium">Contact ↗</span>
                ...
                <a href="https://github.com/shuding/nextra-docs-template" target="_blank" rel="noreferrer" className="nx-p-2 nx-text-current">
                ...
                <a href="https://discord.com/" target="_blank" rel="noreferrer" className="nx-p-2 nx-text-current">
